...
@RequestMapping("/user")
@PreAuthorize("hasAuthority('ADMIN')") // Устанавливает необходимость роли ADMIN для доступа к этим запросам, не действует без @EnableGlobalMethodSecurity(prePostEnabled = true)
